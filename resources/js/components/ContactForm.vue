        ...
        <form>
            <div class="modal-close">
                <button @click="closeModal">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18px" height="18px" style="fill: #7C7972">
            ...
            <div class="form-row">
                ...
                <div class="col-sm-12 pt-2">
                    ...
                    <textarea type="text" class="form-control pt-3 pb-3" id="message" placeholder="Message Details" rows="4"></textarea>
                </div>
            </div>
            <div class="form-row align-items-center">
                ...
                <div class="col-auto pt-3">
                    <button type="submit" class="btn btn-gold-outline press">SEND MESSAGE</button>
                </div>
            </div>
        </form>
