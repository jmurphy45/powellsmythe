<template>
    <div class="">
        <div class="home-content">
            <!-- <img class="mb-4 d-block mx-auto" :src="'/images/sphinx.svg'" width="125px" height="92px"> -->
            <svg viewBox="0 0 491 25.13" width="491" height="26" style="fill: #8b784a">
            ...
            <button class="btn btn-gold-outline press mt-3" @click="openModal">Contact Us</button>
        </div>
